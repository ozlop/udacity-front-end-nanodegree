    ...
    */
    ...
    describe('The Menu', function () {
        ...
        it('menu hidden', function () {
            ...
            expect(menuDiv.classList.contains('menu-hidden')).toBe(true);
        });
         ...
         */
        it('menu open/close', function () {
            let menuBtn = document.querySelector('.menu-icon-link');
            let menuDiv = document.querySelector('body');

            menuBtn.click();
            expect(menuDiv.classList.contains('menu-hidden')).toBe(false);
     ...
     */
        ...
        it('has one initial entry', function (done) {
